...
WINPR_ATTR_NODISCARD WINPR_ATTR_MALLOC(channelTracker_free, 1)
    ChannelStateTracker* channelTracker_new(pServerStaticChannelContext* channel,
                                            ChannelTrackerPeekFn fn, void* data);

WINPR_ATTR_NODISCARD BOOL channelTracker_setMode(ChannelStateTracker* tracker,
...
WINPR_ATTR_NODISCARD BOOL channelTracker_setCurrentPacketSize(ChannelStateTracker* tracker,
                                                              size_t size);
