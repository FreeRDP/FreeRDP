...
struct proxy_module
{
 ...
 static const char* FILTER_TYPE_STRINGS[] = { 
	"KEYBOARD_EVENT", "MOUSE_EVENT", "CLIENT_CHANNEL_DATA", "SERVER_CHANNEL_DATA", 
	"CLIENT_PASSTHROUGH_DYN_CHANNEL_CREATE", "SERVER_FETCH_TARGET_ADDR", "SERVER_PEER_LOGON", 
	"CLIENT_PASSTHROUGH_CHANNEL_CREATE" };

static const char* HOOK_TYPE_STRINGS[] = {
	"CLIENT_INIT_CONNECT", "CLIENT_UNINIT_CONNECT", "CLIENT_PRE_CONNECT",  "CLIENT_POST_CONNECT",
	"CLIENT_POST_DISCONNECT", "CLIENT_POST_VERIFY_X509", "CLIENT_LOGIN_FAILURE", "CLIENT_END_PAINT",
	"SERVER_POST_CONNECT", "SERVER_CHANNELS_ACTIVATE", "SERVER_CHANNELS_INIT", "SERVER_CHANNELS_FREE",
	"SERVER_SESSION_END",
};
