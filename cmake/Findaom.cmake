...
if(UNIX AND NOT ANDROID)
  ...
  pkg_check_modules(PC_AOM QUIET IMPORTED_TARGET GLOBAL aom)
endif(UNIX AND NOT ANDROID)

if(PC_AOM_FOUND)
  set(AOM_FOUND ${PC_AOM_FOUND})
  set(AOM_INCLUDE_DIRS ${PC_AOM_INCLUDE_DIRS})
  set(AOM_LIBRARIES ${PC_AOM_LIBRARIES})
  add_library(aom ALIAS PkgConfig::PC_AOM)
else()
  ...
  if(AOM_FOUND)
    ...
    add_library(aom INTERFACE IMPORTED GLOBAL)
    set_target_properties(
      aom PROPERTIES IMPORTED_LOCATION "${AOM_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES "${AOM_INCLUDE_DIR}"
    )
  else(AOM_FOUND)
