...
if(UNIX AND NOT ANDROID)
  ...
  pkg_check_modules(PC_YUV QUIET IMPORTED_TARGET GLOBAL libyuv)
endif(UNIX AND NOT ANDROID)

if(PC_YUV_FOUND)
  set(YUV_FOUND ${PC_YUV_FOUND})
  set(YUV_INCLUDE_DIRS ${PC_YUV_INCLUDE_DIRS})
  set(YUV_LIBRARIES ${PC_YUV_LIBRARIES})
  add_library(yuv ALIAS PkgConfig::PC_YUV)
else()
