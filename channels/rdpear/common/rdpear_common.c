...
#define RDPEAR_SIMPLE_MESSAGE_TYPE(V)                                                             \
	BOOL ndr_read_##V(WinPrNdrContext* context, wStream* s, const void* hints, V* obj)            \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		return winpr_ndr_struct_read_fromDescr(context, s, &V##_struct, obj);                     \
	}                                                                                             \
	BOOL ndr_write_##V(WinPrNdrContext* context, wStream* s, const void* hints, const V* obj)     \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		return winpr_ndr_struct_write_fromDescr(context, s, &V##_struct, obj);                    \
	}                                                                                             \
	void ndr_destroy_##V(WinPrNdrContext* context, const void* hints, V* obj)                     \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		winpr_ndr_struct_destroy(context, &V##_struct, obj);                                      \
	}                                                                                             \
	...
	{                                                                                             \
		winpr_ndr_struct_dump_fromDescr(logger, lvl, indentLevel, &V##_struct, obj);              \
                                                                                                  ...
                                                                                                  \
	static BOOL ndr_descr_read_##V(WinPrNdrContext* context, wStream* s, const void* hints,       \
	                               void* obj)                                                     \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		return winpr_ndr_struct_read_fromDescr(context, s, &V##_struct, obj);                     \
	}                                                                                             \
	static BOOL ndr_descr_write_##V(WinPrNdrContext* context, wStream* s, const void* hints,      \
	                                const void* obj)                                              \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		return winpr_ndr_struct_write_fromDescr(context, s, &V##_struct, obj);                    \
	}                                                                                             \
	static void ndr_descr_destroy_##V(WinPrNdrContext* context, const void* hints, void* obj)     \
	{                                                                                             \
		WINPR_UNUSED(hints);                                                                      \
		winpr_ndr_struct_destroy(context, &V##_struct, obj);                                      \
	}                                                                                             \
	...
	static WinPrNdrMessageDescr ndr_##V##_descr_s = {                                             \
		WINPR_NDR_ARITY_SIMPLE, sizeof(V),          ndr_descr_read_##V, ndr_descr_write_##V,      \
...
BOOL ndr_read_RPC_UNICODE_STRING(WinPrNdrContext* context, wStream* s, const void* hints,
                                 RPC_UNICODE_STRING* res)
{
	...
	WINPR_UNUSED(hints);
	if (!winpr_ndr_read_uint16(context, s, &Length) ||
	    !winpr_ndr_read_uint16(context, s, &MaximumLength) ||
	    !winpr_ndr_read_refpointer(context, s, &bufferDesc.ptrId) || Length > MaximumLength)
		return FALSE;
	...
	return winpr_ndr_push_deferreds(context, &bufferDesc, 1);
}

static BOOL ndr_descr_read_RPC_UNICODE_STRING(WinPrNdrContext* context, wStream* s,
                                              const void* hints, void* res)
{
	return ndr_read_RPC_UNICODE_STRING(context, s, hints, res);
}

BOOL ndr_write_RPC_UNICODE_STRING(WinPrNdrContext* context, wStream* s,
                                  WINPR_ATTR_UNUSED const void* hints,
                                  const RPC_UNICODE_STRING* res)
{
	WINPR_ASSERT(res);
	if (!winpr_ndr_write_uint32(context, s, res->lenHints.length))
		return FALSE;

	if (!winpr_ndr_write_uint32(context, s, res->lenHints.maxLength))
		return FALSE;

	return winpr_ndr_write_data(context, s, res->Buffer, res->strLength);
}

static BOOL ndr_write_RPC_UNICODE_STRING_(WinPrNdrContext* context, wStream* s, const void* hints,
                                          const void* pvres)
{
...
void ndr_destroy_RPC_UNICODE_STRING(WinPrNdrContext* context, const void* hints,
...
static void ndr_descr_destroy_RPC_UNICODE_STRING(WinPrNdrContext* context, const void* hints,
                                                 void* obj)
{
...
static BOOL ndr_read_RPC_UNICODE_STRING_Array(WinPrNdrContext* context, wStream* s,
                                              const void* hints, void* v)
{
	WINPR_ASSERT(context);
	WINPR_ASSERT(s);
	WINPR_ASSERT(hints);
	return winpr_ndr_read_uconformant_array(context, s, hints, ndr_RPC_UNICODE_STRING_descr(), v);
}

static BOOL ndr_write_RPC_UNICODE_STRING_Array(WinPrNdrContext* context, wStream* s,
                                               const void* ghints, const void* v)
{
	...
	return winpr_ndr_write_uconformant_array(context, s, hints->count,
...
BOOL ndr_read_KERB_RPC_INTERNAL_NAME(WinPrNdrContext* context, wStream* s, const void* hints,
                                     KERB_RPC_INTERNAL_NAME* res)
{
	...
	if (!winpr_ndr_read_uint16(context, s, &res->NameType) ||
	    !winpr_ndr_read_uint16(context, s, &nameCount))
		return FALSE;

	res->nameHints.count = nameCount;

	return winpr_ndr_read_refpointer(context, s, &names.ptrId) &&
	       winpr_ndr_push_deferreds(context, &names, 1);
}

static BOOL ndr_descr_read_KERB_RPC_INTERNAL_NAME(WinPrNdrContext* context, wStream* s,
                                                  const void* hints, void* res)
{
	return ndr_read_KERB_RPC_INTERNAL_NAME(context, s, hints, res);
}

BOOL ndr_write_KERB_RPC_INTERNAL_NAME(WinPrNdrContext* context, wStream* s, const void* hints,
...
void ndr_destroy_KERB_RPC_INTERNAL_NAME(WinPrNdrContext* context, const void* hints,
...
static void ndr_descr_destroy_KERB_RPC_INTERNAL_NAME(WinPrNdrContext* context, const void* hints,
                                                     void* obj)
{
