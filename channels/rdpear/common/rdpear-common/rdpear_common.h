...
#define RDPEAR_COMMON_MESSAGE_DECL(V)                                                            \
	FREERDP_LOCAL BOOL ndr_read_##V(WinPrNdrContext* context, wStream* s, const void* hints,     \
	                                V* obj);                                                     \
	FREERDP_LOCAL BOOL ndr_write_##V(WinPrNdrContext* context, wStream* s, const void* hints,    \
	                                 const V* obj);                                              \
	FREERDP_LOCAL void ndr_destroy_##V(WinPrNdrContext* context, const void* hints, V* obj);     \
