...
struct s_RDPINPUT_CONTACT_POINT
{
	BOOL dirty;
	BOOL active;
	UINT32 contactId;
...
typedef struct s_RDPINPUT_CONTACT_POINT RDPINPUT_CONTACT_POINT;

struct s_RDPINPUT_PEN_CONTACT_POINT
{
	BOOL dirty;
	BOOL active;
	INT32 externalId;
...
typedef struct s_RDPINPUT_PEN_CONTACT_POINT RDPINPUT_PEN_CONTACT_POINT;
