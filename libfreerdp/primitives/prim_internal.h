...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelBGRA(BYTE* dst, DWORD formatSize, UINT32 format,
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelBGRX(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelRGBA(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelRGBX(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelABGR(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelXBGR(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelARGB(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
static inline WINPR_ATTR_NODISCARD BYTE* writePixelXRGB(BYTE* dst, DWORD formatSize, UINT32 format,
                                                        BYTE R, BYTE G, BYTE B, BYTE A)
{
	WINPR_UNUSED(formatSize);
	WINPR_UNUSED(format);
...
writePixelGenericAlpha(BYTE* dst, DWORD formatSize, UINT32 format, BYTE R, BYTE G, BYTE B, BYTE A)
{
...
static inline WINPR_ATTR_NODISCARD BYTE*
writePixelGeneric(BYTE* dst, DWORD formatSize, UINT32 format, BYTE R, BYTE G, BYTE B, BYTE A)
{
	UINT32 color = FreeRDPGetColor(format, R, G, B, A);
...
static inline WINPR_ATTR_NODISCARD fkt_writePixel getPixelWriteFunction(DWORD format, BOOL useAlpha)
{
	switch (format)
	{
...
static inline WINPR_ATTR_NODISCARD BYTE CLIP(INT64 X)
{
	if (X > 255L)
		return 255L;
...
static inline WINPR_ATTR_NODISCARD BYTE CONDITIONAL_CLIP(INT32 in, BYTE original)
{
	BYTE out = CLIP(in);
	BYTE diff = 0;
	if (out > original)
 ...
 * | B |   ( | 256   475      0 | | V - 128 | )
 */
static inline WINPR_ATTR_NODISCARD INT32 C(INT32 Y)
{
	return (Y)-0;
}

static inline WINPR_ATTR_NODISCARD INT32 D(INT32 U)
{
	return (U)-128;
}

static inline WINPR_ATTR_NODISCARD INT32 E(INT32 V)
{
	return (V)-128;
}

static inline WINPR_ATTR_NODISCARD BYTE YUV2R(INT32 Y, INT32 U, INT32 V)
{
...
static inline WINPR_ATTR_NODISCARD BYTE YUV2G(INT32 Y, INT32 U, INT32 V)
{
...
static inline WINPR_ATTR_NODISCARD BYTE YUV2B(INT32 Y, INT32 U, INT32 V)
{
 ...
 * | V |    ( | 128  -116    -12 | | B | )        | 128 |
 */
static inline WINPR_ATTR_NODISCARD BYTE RGB2Y(INT32 R, INT32 G, INT32 B)
{
	const INT32 val = ((54 * R + 183 * G + 18 * B) >> 8);
	return WINPR_ASSERTING_INT_CAST(BYTE, val);
}

static inline WINPR_ATTR_NODISCARD BYTE RGB2U(INT32 R, INT32 G, INT32 B)
{
	const INT32 val = (((-29 * R - 99 * G + 128 * B) >> 8) + 128);
	return WINPR_ASSERTING_INT_CAST(BYTE, val);
}

static inline WINPR_ATTR_NODISCARD BYTE RGB2V(INT32 R, INT32 G, INT32 B)
{
	const INT32 val = (((128 * R - 116 * G - 12 * B) >> 8) + 128);
	return WINPR_ASSERTING_INT_CAST(BYTE, val);
}

static inline WINPR_ATTR_NODISCARD BYTE* writeYUVPixel(BYTE* dst, UINT32 DstFormat, INT32 y,
                                                       INT32 u, INT32 v, fkt_writePixel fkt)
{
	WINPR_ASSERT(fkt);
