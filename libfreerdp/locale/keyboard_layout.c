...
struct s_RDP_KEYBOARD_LAYOUT_VARIANT
{
	DWORD code;       /* Keyboard layout code */
	DWORD id;         /* Keyboard variant ID */
	const char* name; /* Keyboard layout variant name */
};
typedef struct s_RDP_KEYBOARD_LAYOUT_VARIANT RDP_KEYBOARD_LAYOUT_VARIANT;
...
struct s_RDP_KEYBOARD_IME
{
	DWORD code;       /* Keyboard layout code */
	const char* file; /* IME file */
	const char* name; /* Keyboard layout name */
};
typedef struct s_RDP_KEYBOARD_IME RDP_KEYBOARD_IME;
