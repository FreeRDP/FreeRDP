...
static const struct settings_str_entry settings_map[] = {
	...
	{ FreeRDP_NumMonitorScales, FREERDP_SETTINGS_TYPE_UINT32, "FreeRDP_NumMonitorScales" },
	...
	{ FreeRDP_MonitorScales, FREERDP_SETTINGS_TYPE_POINTER, "FreeRDP_MonitorScales" },
