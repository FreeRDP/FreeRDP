...
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_read_security_header(rdpRdp* rdp, wStream* s,
                                                                 UINT16* flags, UINT16* length);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_write_security_header(rdpRdp* rdp, wStream* s,
                                                                  UINT16 flags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_read_share_control_header(rdpRdp* rdp, wStream* s,
                                                                      UINT16* tpktLength,
                                                                      UINT16* remainingLength,
                                                                      UINT16* type,
                                                                      UINT16* channel_id);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_read_share_data_header(rdpRdp* rdp, wStream* s,
                                                                   UINT16* length, BYTE* type,
                                                                   UINT32* share_id,
                                                                   BYTE* compressed_type,
                                                                   UINT16* compressed_len);

FREERDP_LOCAL WINPR_ATTR_NODISCARD wStream* rdp_send_stream_init(rdpRdp* rdp, UINT16* sec_flags);
FREERDP_LOCAL WINPR_ATTR_NODISCARD wStream* rdp_send_stream_pdu_init(rdpRdp* rdp,
                                                                     UINT16* sec_flags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_read_header(rdpRdp* rdp, wStream* s, UINT16* length,
                                                        UINT16* channel_id);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_write_header(rdpRdp* rdp, wStream* s, size_t length,
                                                         UINT16 channel_id, UINT16 sec_flags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_pdu(rdpRdp* rdp, wStream* s, UINT16 type,
                                                     UINT16 channel_id, UINT16 sec_flags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD wStream* rdp_data_pdu_init(rdpRdp* rdp, UINT16* sec_flags);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_data_pdu(rdpRdp* rdp, wStream* s, BYTE type,
                                                          UINT16 channel_id, UINT16 sec_flags);
FREERDP_LOCAL WINPR_ATTR_NODISCARD state_run_t rdp_recv_data_pdu(rdpRdp* rdp, wStream* s);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send(rdpRdp* rdp, wStream* s, UINT16 channelId,
                                                 UINT16 sec_flags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_channel_data(rdpRdp* rdp, UINT16 channelId,
                                                              const BYTE* data, size_t size);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_channel_send_packet(rdpRdp* rdp, UINT16 channelId,
                                                                size_t totalSize, UINT32 flags,
                                                                const BYTE* data, size_t chunkSize);

FREERDP_LOCAL WINPR_ATTR_NODISCARD wStream* rdp_message_channel_pdu_init(rdpRdp* rdp,
                                                                         UINT16* sec_flags);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_message_channel_pdu(rdpRdp* rdp, wStream* s,
                                                                     UINT16 sec_flags);
FREERDP_LOCAL WINPR_ATTR_NODISCARD state_run_t rdp_recv_message_channel_pdu(rdpRdp* rdp, wStream* s,
                                                                            UINT16 securityFlags);

FREERDP_LOCAL WINPR_ATTR_NODISCARD state_run_t rdp_recv_out_of_sequence_pdu(rdpRdp* rdp, wStream* s,
                                                                            UINT16 pduType,
                                                                            UINT16 length);

FREERDP_LOCAL WINPR_ATTR_NODISCARD state_run_t rdp_recv_callback(rdpTransport* transport,
                                                                 wStream* s, void* extra);

FREERDP_LOCAL WINPR_ATTR_NODISCARD int rdp_check_fds(rdpRdp* rdp);

FREERDP_LOCAL void rdp_free(rdpRdp* rdp);

WINPR_ATTR_MALLOC(rdp_free, 1)
FREERDP_LOCAL WINPR_ATTR_NODISCARD rdpRdp* rdp_new(rdpContext* context);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_reset(rdpRdp* rdp);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_io_callback_set_event(rdpRdp* rdp, BOOL reset);

FREERDP_LOCAL WINPR_ATTR_NODISCARD const rdpTransportIo* rdp_get_io_callbacks(rdpRdp* rdp);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_set_io_callbacks(rdpRdp* rdp,
                                                             const rdpTransportIo* io_callbacks);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_set_io_callback_context(rdpRdp* rdp, void* usercontext);
FREERDP_LOCAL WINPR_ATTR_NODISCARD void* rdp_get_io_callback_context(rdpRdp* rdp);
