...
FREERDP_LOCAL WINPR_ATTR_NODISCARD rdpChannels* freerdp_channels_new(freerdp* instance);

FREERDP_LOCAL WINPR_ATTR_NODISCARD UINT freerdp_channels_disconnect(rdpChannels* channels,
                                                                    freerdp* instance);
...
FREERDP_LOCAL WINPR_ATTR_NODISCARD UINT freerdp_channels_pre_connect(rdpChannels* channels,
                                                                     freerdp* instance);
FREERDP_LOCAL WINPR_ATTR_NODISCARD UINT freerdp_channels_post_connect(rdpChannels* channels,
                                                                      freerdp* instance);

/** @since version 3.9.0 */
FREERDP_LOCAL WINPR_ATTR_NODISCARD SSIZE_T freerdp_client_channel_get_registered_event_handles(
    rdpChannels* channels, HANDLE* events, DWORD count);
