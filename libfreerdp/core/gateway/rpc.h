...
struct s_RPC_FAULT_CODE
{
	UINT32 code;
	const char* name;
	const char* category;
};
typedef struct s_RPC_FAULT_CODE RPC_FAULT_CODE;
...
struct s_RPC_SECURITY_PROVIDER_INFO
{
	UINT32 Id;
	LONG EvenLegs;
	LONG NumLegs;
};
typedef struct s_RPC_SECURITY_PROVIDER_INFO RPC_SECURITY_PROVIDER_INFO;

enum e_RPC_CLIENT_STATE
{
...
typedef enum e_RPC_CLIENT_STATE RPC_CLIENT_STATE;

enum e_RPC_CLIENT_CALL_STATE
{
...
typedef enum e_RPC_CLIENT_CALL_STATE RPC_CLIENT_CALL_STATE;
...
enum e_CLIENT_IN_CHANNEL_STATE
{
...
typedef enum e_CLIENT_IN_CHANNEL_STATE CLIENT_IN_CHANNEL_STATE;
...
enum e_CLIENT_OUT_CHANNEL_STATE
{
...
typedef enum e_CLIENT_OUT_CHANNEL_STATE CLIENT_OUT_CHANNEL_STATE;
...
enum e_VIRTUAL_CONNECTION_STATE
{
...
typedef enum e_VIRTUAL_CONNECTION_STATE VIRTUAL_CONNECTION_STATE;
