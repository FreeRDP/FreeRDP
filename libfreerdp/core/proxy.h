...
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL proxy_prepare(rdpSettings* settings,
                                                      const char** lpPeerHostname,
                                                      UINT16* lpPeerPort,
                                                      const char** lpProxyUsername,
                                                      const char** lpProxyPassword);

FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL proxy_connect(rdpContext* context, BIO* bio,
