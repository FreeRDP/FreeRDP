...
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_recv_client_info(rdpRdp* rdp, wStream* s);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_client_info(rdpRdp* rdp);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_recv_save_session_info(rdpRdp* rdp, wStream* s);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_save_session_info(rdpContext* context, UINT32 type,
                                                                   void* data);
FREERDP_LOCAL WINPR_ATTR_NODISCARD BOOL rdp_send_server_status_info(rdpContext* context,
                                                                    UINT32 status);
