...
static inline WINPR_ATTR_NODISCARD UINT32 freerdp_image_inverted_pointer_color(UINT32 x, UINT32 y,
                                                                               UINT32 format)
{
	/**
...
static inline WINPR_ATTR_NODISCARD UINT32 div_ceil(UINT32 a, UINT32 b)
{
	return (a + (b - 1)) / b;
}

static inline WINPR_ATTR_NODISCARD UINT32 round_up(UINT32 a, UINT32 b)
{
...
static inline WINPR_ATTR_NODISCARD BOOL overlapping(const BYTE* pDstData, UINT32 nYDst,
                                                    UINT32 nDstStep, const BYTE* pSrcData,
                                                    UINT32 nYSrc, UINT32 nSrcStep, UINT32 nHeight)
{
...
static inline WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_bgr24_bgrx32(
...
static inline WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_bgrx32_bgrx32(
    BYTE* WINPR_RESTRICT pDstData, UINT32 nDstStep, UINT32 nXDst, UINT32 nYDst, UINT32 nWidth,
    UINT32 nHeight, const BYTE* WINPR_RESTRICT pSrcData, UINT32 nSrcStep, UINT32 nXSrc,
    UINT32 nYSrc, int64_t srcVMultiplier, int64_t srcVOffset, int64_t dstVMultiplier,
    int64_t dstVOffset)
...
static inline WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_generic(
    BYTE* WINPR_RESTRICT pDstData, UINT32 DstFormat, UINT32 nDstStep, UINT32 nXDst, UINT32 nYDst,
...
static inline WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_no_overlap_dst_alpha(
