...
struct s_RFX_COMPONENT_CODEC_QUANT
{
	BYTE LL3;
	BYTE HL3;
	BYTE LH3;
...
typedef struct s_RFX_COMPONENT_CODEC_QUANT RFX_COMPONENT_CODEC_QUANT;

struct s_RFX_PROGRESSIVE_CODEC_QUANT
{
	BYTE quality;
...
typedef struct s_RFX_PROGRESSIVE_CODEC_QUANT RFX_PROGRESSIVE_CODEC_QUANT;

struct s_PROGRESSIVE_BLOCK
{
	UINT16 blockType;
	UINT32 blockLen;
};
typedef struct s_PROGRESSIVE_BLOCK PROGRESSIVE_BLOCK;

struct s_PROGRESSIVE_BLOCK_SYNC
{
	UINT16 blockType;
	UINT32 blockLen;
...
typedef struct s_PROGRESSIVE_BLOCK_SYNC PROGRESSIVE_BLOCK_SYNC;

struct s_PROGRESSIVE_BLOCK_CONTEXT
{
	UINT16 blockType;
	UINT32 blockLen;
...
typedef struct s_PROGRESSIVE_BLOCK_CONTEXT PROGRESSIVE_BLOCK_CONTEXT;

struct s_RFX_PROGRESSIVE_TILE
{
	UINT16 blockType;
	UINT32 blockLen;
...
typedef struct s_RFX_PROGRESSIVE_TILE RFX_PROGRESSIVE_TILE;
...
struct s_PROGRESSIVE_BLOCK_FRAME_BEGIN
{
	UINT16 blockType;
	UINT32 blockLen;
...
typedef struct s_PROGRESSIVE_BLOCK_FRAME_BEGIN PROGRESSIVE_BLOCK_FRAME_BEGIN;

struct s_PROGRESSIVE_BLOCK_FRAME_END
{
	UINT16 blockType;
	UINT32 blockLen;
};
typedef struct s_PROGRESSIVE_BLOCK_FRAME_END PROGRESSIVE_BLOCK_FRAME_END;

struct s_PROGRESSIVE_SURFACE_CONTEXT
{
	UINT16 id;
	UINT32 width;
	UINT32 height;
...
typedef struct s_PROGRESSIVE_SURFACE_CONTEXT PROGRESSIVE_SURFACE_CONTEXT;

enum e_WBT_STATE_FLAG
{
	FLAG_WBT_SYNC = 0x01,
...
typedef enum e_WBT_STATE_FLAG WBT_STATE_FLAG;
