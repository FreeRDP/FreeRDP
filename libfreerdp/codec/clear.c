...
struct s_CLEAR_GLYPH_ENTRY
{
	UINT32 size;
	UINT32 count;
	UINT32* pixels;
};
typedef struct s_CLEAR_GLYPH_ENTRY CLEAR_GLYPH_ENTRY;

struct s_CLEAR_VBAR_ENTRY
{
	UINT32 size;
	UINT32 count;
	BYTE* pixels;
};
typedef struct s_CLEAR_VBAR_ENTRY CLEAR_VBAR_ENTRY;
