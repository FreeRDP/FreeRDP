...
extern "C"
{
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD rdpBitmapCache* bitmap_cache_new(rdpContext* context);

	FREERDP_LOCAL void free_bitmap_update(rdpContext* context, BITMAP_UPDATE* pointer);

	WINPR_ATTR_MALLOC(free_bitmap_update, 2)
	FREERDP_LOCAL WINPR_ATTR_NODISCARD BITMAP_UPDATE*
	copy_bitmap_update(rdpContext* context, const BITMAP_UPDATE* pointer);
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD CACHE_BITMAP_ORDER*
	copy_cache_bitmap_order(rdpContext* context, const CACHE_BITMAP_ORDER* order);
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD CACHE_BITMAP_V2_ORDER*
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD CACHE_BITMAP_V3_ORDER*
