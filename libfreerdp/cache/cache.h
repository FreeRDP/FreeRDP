...
extern "C"
{
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD rdpCache* cache_new(rdpContext* context);
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD CACHE_COLOR_TABLE_ORDER*
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD SURFACE_BITS_COMMAND*
