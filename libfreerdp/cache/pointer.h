...
extern "C"
{
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD rdpPointerCache* pointer_cache_new(rdpContext* context);
	...
	FREERDP_LOCAL WINPR_ATTR_NODISCARD POINTER_NEW_UPDATE*
	copy_pointer_new_update(rdpContext* context, const POINTER_NEW_UPDATE* pointer);
