...
#define SYSCOMMAND_ID_REQUEST_CONTROL 1001
	...
	FREERDP_API WINPR_ATTR_NODISCARD int RdpClientEntry(RDP_CLIENT_ENTRY_POINTS* pEntryPoints);
	FREERDP_API WINPR_ATTR_NODISCARD int freerdp_client_set_window_size(wfContext* wfc, int width,
	                                                                    int height);
