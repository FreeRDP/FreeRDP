...
struct xf_context
{
	...
	Atom d_XWAYLAND_MAY_GRAB_KEYBOARD;

	Atom d_NET_WM_ICON;
	Atom d_MOTIF_WM_HINTS;
	Atom d_NET_CURRENT_DESKTOP;
	Atom d_NET_WORKAREA;

	Atom d_NET_SUPPORTED;
	Atom d_NET_SUPPORTING_WM_CHECK;

	Atom d_NET_WM_STATE;
	Atom d_NET_WM_STATE_FULLSCREEN;
	Atom d_NET_WM_STATE_MAXIMIZED_HORZ;
	Atom d_NET_WM_STATE_MAXIMIZED_VERT;
	Atom d_NET_WM_STATE_SKIP_TASKBAR;
	Atom d_NET_WM_STATE_SKIP_PAGER;

	Atom d_NET_WM_FULLSCREEN_MONITORS;
	...
	Atom d_NET_WM_WINDOW_TYPE_POPUP;
	Atom d_NET_WM_WINDOW_TYPE_POPUP_MENU;
	Atom d_NET_WM_WINDOW_TYPE_DROPDOWN_MENU;

	Atom d_NET_WM_MOVERESIZE;
	Atom d_NET_MOVERESIZE_WINDOW;
