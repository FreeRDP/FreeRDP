...
WINPR_ATTR_NODISCARD const char* x11_error_to_string(xfContext* xfc, int error, char* buffer,
                                                     size_t size);
...
WINPR_ATTR_NODISCARD char* Safe_XGetAtomNameEx(wLog* log, Display* display, Atom atom,
                                               const char* varname);
WINPR_ATTR_NODISCARD Atom Logging_XInternAtom(wLog* log, Display* display, _Xconst char* atom_name,
                                              Bool only_if_exists);

typedef BOOL (*fn_action_script_run)(xfContext* xfc, const char* buffer, size_t size, void* user,
                                     const char* what, const char* arg);
WINPR_ATTR_NODISCARD BOOL run_action_script(xfContext* xfc, const char* what, const char* arg,
                                            fn_action_script_run fkt, void* user);
...
WINPR_ATTR_NODISCARD Pixmap LogDynAndXCreatePixmap_ex(wLog* log, const char* file, const char* fkt,
                                                      size_t line, Display* display, Drawable d,
...
WINPR_ATTR_NODISCARD int LogDynAndXFreePixmap_ex(wLog* log, const char* file, const char* fkt,
                                                 size_t line, Display* display, Pixmap pixmap);
...
WINPR_ATTR_NODISCARD Window LogDynAndXCreateWindow_ex(
    wLog* log, const char* file, const char* fkt, size_t line, Display* display, Window parent,
...
WINPR_ATTR_NODISCARD int LogDynAndXRaiseWindow_ex(wLog* log, const char* file, const char* fkt,
...
WINPR_ATTR_NODISCARD int LogDynAndXMapWindow_ex(wLog* log, const char* file, const char* fkt,
                                                size_t line, Display* display, Window w);

#define LogDynAndXUnmapWindow(log, display, w) \
	LogDynAndXUnmapWindow_ex((log), __FILE__, __func__, __LINE__, (display), (w))

WINPR_ATTR_NODISCARD int LogDynAndXUnmapWindow_ex(wLog* log, const char* file, const char* fkt,
                                                  size_t line, Display* display, Window w);
...
WINPR_ATTR_NODISCARD int LogDynAndXMoveResizeWindow_ex(wLog* log, const char* file, const char* fkt,
                                                       size_t line, Display* display, Window w,
...
WINPR_ATTR_NODISCARD Status LogDynAndXWithdrawWindow_ex(wLog* log, const char* file,
...
WINPR_ATTR_NODISCARD int LogDynAndXMoveWindow_ex(wLog* log, const char* file, const char* fkt,
                                                 size_t line, Display* display, Window w, int x,
                                                 int y);
...
WINPR_ATTR_NODISCARD int LogDynAndXResizeWindow_ex(wLog* log, const char* file, const char* fkt,
                                                   size_t line, Display* display, Window w,
                                                   unsigned int width, unsigned int height);
...
WINPR_ATTR_NODISCARD int LogDynAndXClearWindow_ex(wLog* log, const char* file, const char* fkt,
                                                  size_t line, Display* display, Window w);
...
WINPR_ATTR_NODISCARD int LogDynAndXGetWindowProperty_ex(
    wLog* log, const char* file, const char* fkt, size_t line, Display* display, Window w,
    Atom property, long long_offset, long long_length, Bool c_delete, Atom req_type,
...
WINPR_ATTR_NODISCARD int LogDynAndXReparentWindow_ex(wLog* log, const char* file, const char* fkt,
                                                     size_t line, Display* display, Window w,
...
WINPR_ATTR_NODISCARD int LogDynAndXChangeProperty_ex(wLog* log, const char* file, const char* fkt,
                                                     size_t line, Display* display, Window w,
...
WINPR_ATTR_NODISCARD int LogDynAndXDeleteProperty_ex(wLog* log, const char* file, const char* fkt,
                                                     size_t line, Display* display, Window w,
                                                     Atom property);
...
WINPR_ATTR_NODISCARD int LogDynAndXConvertSelection_ex(wLog* log, const char* file, const char* fkt,
...
WINPR_ATTR_NODISCARD GC LogDynAndXCreateGC_ex(wLog* log, const char* file, const char* fkt,
                                              size_t line, Display* display, Drawable d,
...
WINPR_ATTR_NODISCARD int LogDynAndXFreeGC_ex(wLog* log, const char* file, const char* fkt,
                                             size_t line, Display* display, GC gc);
...
#define LogDynAndXCreateImage(log, display, visual, depth, format, offset, data, width, height, \
	...
	LogDynAndXCreateImage_ex(log, __FILE__, __func__, __LINE__, (display), (visual), (depth),   \
	                         ...
	                         (bytes_per_line))
WINPR_ATTR_NODISCARD XImage* LogDynAndXCreateImage_ex(wLog* log, const char* file, const char* fkt,
                                                      size_t line, Display* display, Visual* visual,
...
WINPR_ATTR_NODISCARD int LogDynAndXPutImage_ex(wLog* log, const char* file, const char* fkt,
                                               size_t line, Display* display, Drawable d, GC gc,
                                               XImage* image, int src_x, int src_y, int dest_x,
...
WINPR_ATTR_NODISCARD int LogDynAndXCopyArea_ex(wLog* log, const char* file, const char* fkt,
                                               size_t line, Display* display, Pixmap src,
                                               Window dest, GC gc, int src_x, int src_y,
...
WINPR_ATTR_NODISCARD Status LogDynAndXSendEvent_ex(wLog* log, const char* file, const char* fkt,
                                                   size_t line, Display* display, Window w,
...
WINPR_ATTR_NODISCARD Status LogDynAndXFlush_ex(wLog* log, const char* file, const char* fkt,
                                               size_t line, Display* display);

#define LogDynAndXSync(log, display, discard) \
	LogDynAndXSync_ex(log, __FILE__, __func__, __LINE__, (display), (discard))
WINPR_ATTR_NODISCARD int LogDynAndXSync_ex(wLog* log, const char* file, const char* fkt,
                                           size_t line, Display* display, Bool discard);
...
WINPR_ATTR_NODISCARD Window LogDynAndXGetSelectionOwner_ex(wLog* log, const char* file,
                                                           const char* fkt, size_t line,
...
#define LogDynAndXSetSelectionOwner(log, display, selection, owner, time)                     \
	LogDynAndXSetSelectionOwner_ex(log, __FILE__, __func__, __LINE__, (display), (selection), \
	                               (owner), (time))
WINPR_ATTR_NODISCARD int LogDynAndXSetSelectionOwner_ex(wLog* log, const char* file,
                                                        const char* fkt, size_t line,
                                                        Display* display, Atom selection,
...
WINPR_ATTR_NODISCARD int LogDynAndXDestroyWindow_ex(wLog* log, const char* file, const char* fkt,
...
#define LogDynAndXChangeWindowAttributes(log, display, window, valuemask, attributes)           \
	LogDynAndXChangeWindowAttributes_ex(log, __FILE__, __func__, __LINE__, (display), (window), \
	                                    (valuemask), (attributes))
WINPR_ATTR_NODISCARD int LogDynAndXChangeWindowAttributes_ex(wLog* log, const char* file,
                                                             const char* fkt, size_t line,
...
#define LogDynAndXSetTransientForHint(log, display, window, prop_window)                     \
	LogDynAndXSetTransientForHint_ex(log, __FILE__, __func__, __LINE__, (display), (window), \
	                                 (prop_window))
WINPR_ATTR_NODISCARD int LogDynAndXSetTransientForHint_ex(wLog* log, const char* file,
                                                          const char* fkt, size_t line,
                                                          Display* display, Window window,
                                                          Window prop_window);
...
WINPR_ATTR_NODISCARD int LogDynAndXCloseDisplay_ex(wLog* log, const char* file, const char* fkt,
                                                   size_t line, Display* display);
...
WINPR_ATTR_NODISCARD int LogDynAndXSetClipMask_ex(wLog* log, const char* file, const char* fkt,
                                                  size_t line, Display* display, GC gc,
                                                  Pixmap pixmap);

#define LogDynAndXSetRegion(log, display, gc, r) \
	LogDynAndXSetRegion_ex(log, __FILE__, __func__, __LINE__, (display), (gc), (r))
WINPR_ATTR_NODISCARD int LogDynAndXSetRegion_ex(wLog* log, const char* file, const char* fkt,
                                                size_t line, Display* display, GC gc, Region r);
...
WINPR_ATTR_NODISCARD int LogDynAndXSetBackground_ex(wLog* log, const char* file, const char* fkt,
                                                    size_t line, Display* display, GC gc,
...
WINPR_ATTR_NODISCARD int LogDynAndXSetForeground_ex(wLog* log, const char* file, const char* fkt,
                                                    size_t line, Display* display, GC gc,
...
WINPR_ATTR_NODISCARD int LogDynAndXSetFillStyle_ex(wLog* log, const char* file, const char* fkt,
                                                   size_t line, Display* display, GC gc,
                                                   int fill_style);
...
#define LogDynAndXFillRectangle(log, display, w, gc, x, y, width, height)                         \
	LogDynAndXFillRectangle_ex(log, __FILE__, __func__, __LINE__, (display), (w), (gc), (x), (y), \
	                           (width), (height))
WINPR_ATTR_NODISCARD int LogDynAndXFillRectangle_ex(wLog* log, const char* file, const char* fkt,
                                                    size_t line, Display* display, Window w, GC gc,
                                                    int x, int y, unsigned int width,
                                                    unsigned int height);
...
WINPR_ATTR_NODISCARD int LogDynAndXSetFunction_ex(wLog* log, const char* file, const char* fkt,
                                                  size_t line, Display* display, GC gc,
                                                  int function);
...
WINPR_ATTR_NODISCARD int LogDynAndXRestackWindows_ex(wLog* log, const char* file, const char* fkt,
                                                     size_t line, Display* display, Window* windows,
                                                     int nwindows);

WINPR_ATTR_NODISCARD BOOL IsGnome(void);

WINPR_ATTR_NODISCARD char* getConfigOption(BOOL system, const char* option);

WINPR_ATTR_NODISCARD const char* request_code_2_str(int code);
