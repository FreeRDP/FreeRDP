...
FREERDP_API WINPR_ATTR_NODISCARD int xf_list_monitors(xfContext* xfc);
FREERDP_API WINPR_ATTR_NODISCARD BOOL xf_detect_monitors(xfContext* xfc, UINT32* pWidth,
                                                         UINT32* pHeight);
