...
WINPR_ATTR_NODISCARD COMMAND_LINE_ARGUMENT_A* xf_monitor_arguments(size_t* count);
WINPR_ATTR_NODISCARD int xf_monitor_handle_option(const COMMAND_LINE_ARGUMENT_A* arg,
                                                   void* userData);
