...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND
    ${CMAKE_COMMAND} -E env ${OSSL_ENV}
    perl <SOURCE_DIR>/Configure ${OSSL_ARCH}
    no-shared no-module no-tests no-apps no-docs no-legacy no-dso no-ssl-trace
    --prefix=${OPENSSL_INSTALL_DIR}
    --libdir=${OPENSSL_INSTALL_DIR}
    --openssldir=${OPENSSL_INSTALL_DIR}
  BUILD_COMMAND
    ${CMAKE_COMMAND} -E env ${OSSL_ENV}
    make build_libs -j
  INSTALL_COMMAND
    ${CMAKE_COMMAND} -E make_directory ${OPENSSL_INSTALL_DIR}/include/openssl
