...
WINPR_ATTR_NODISCARD int tf_on_channel_connected(freerdp* instance, const char* name,
                                                 void* pInterface);
WINPR_ATTR_NODISCARD int tf_on_channel_disconnected(freerdp* instance, const char* name,
                                                    void* pInterface);
