...
if(PLATFORM MATCHES "SIMULATOR")
  ...
  set(_ossl_cc_extra "-target ${_ossl_arch}-apple-ios${DEPLOYMENT_TARGET}-simulator -mios-simulator-version-min=${DEPLOYMENT_TARGET}")
else()
...
execute_process(COMMAND xcrun --sdk ${_ossl_sdk} --show-sdk-version OUTPUT_VARIABLE _ossl_sdk_ver OUTPUT_STRIP_TRAILING_WHITESPACE)
...
set(_ossl_env
    "CROSS_TOP=${_ossl_cross_top}"
    "CROSS_SDK=${_ossl_cross_sdk}"
    "CC=${_ossl_cc}"
)
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND
    ${CMAKE_COMMAND} -E env ${_ossl_env} perl <SOURCE_DIR>/Configure ${_ossl_config_args} no-shared no-tests
    no-apps no-docs --prefix=${DEPS_INSTALL_DIR} --libdir=lib
