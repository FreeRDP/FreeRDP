...
OUTPUT_VARIABLE DEFAULTS_OUT
    ...
    foreach(line ${info_plist})
      if(line MATCHES "^.*CFBundleExecutable =.*")
        string(REGEX REPLACE "^.*CFBundleExecutable =(.*)$" "\\1" bundle_executable "${line}")
        break()
      endif()
    endforeach()

    string(STRIP "${bundle_executable}" bundle_executable)
    if(NOT bundle_executable STREQUAL "")
      if(EXISTS "${bundle}/${bundle_executable}")
        set(result "${bundle}/${bundle_executable}")
      else()
        ...
        #
        set(result "error: '${bundle}/${bundle_executable}' does not exist")
      endif()
    endif()
