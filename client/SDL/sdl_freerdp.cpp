...
static void context_free(sdlContext* sdl)
{
	if (sdl)
...
int main(int argc, char* argv[])
{
	...
	std::unique_ptr<sdlContext, void (*)(sdlContext*)> sdl(
	    reinterpret_cast<sdlContext*>(freerdp_client_context_new(&clientEntryPoints)),
	    context_free);
