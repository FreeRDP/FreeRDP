...
static const COMMAND_LINE_ARGUMENT_A global_cmd_args[] = {
...
#endif
	{ "multimon", COMMAND_LINE_VALUE_BOOL | COMMAND_LINE_VALUE_OPTIONAL, "force|off",
	...
	{ "smart-sizing", COMMAND_LINE_VALUE_BOOL | COMMAND_LINE_VALUE_OPTIONAL, "<width>x<height>|off",
	  BoolValueFalse, nullptr, -1, nullptr, "Scale remote desktop to window size" },
