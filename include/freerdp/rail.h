...
FREERDP_API WINPR_ATTR_NODISCARD BOOL rail_read_unicode_string(wStream* s,
	                                                           RAIL_UNICODE_STRING* unicode_string);
FREERDP_API WINPR_ATTR_NODISCARD BOOL
utf8_string_to_rail_string(const char* string, RAIL_UNICODE_STRING* unicode_string);
...
rail_handshake_ex_flags_to_string(UINT32 flags, char* buffer, size_t len);
