...
typedef struct s_CLIPRDR_MFPICT CLIPRDR_MFPICT;
...
struct s_CLIPRDR_HEADER
{
	DEFINE_CLIPRDR_HEADER_COMMON();
};
typedef struct s_CLIPRDR_HEADER CLIPRDR_HEADER;

struct s_CLIPRDR_CAPABILITY_SET
{
	UINT16 capabilitySetType;
	UINT16 capabilitySetLength;
};
typedef struct s_CLIPRDR_CAPABILITY_SET CLIPRDR_CAPABILITY_SET;

struct s_CLIPRDR_GENERAL_CAPABILITY_SET
{
	UINT16 capabilitySetType;
	UINT16 capabilitySetLength;
...
typedef struct s_CLIPRDR_GENERAL_CAPABILITY_SET CLIPRDR_GENERAL_CAPABILITY_SET;

struct s_CLIPRDR_CAPABILITIES
{
	DEFINE_CLIPRDR_HEADER_COMMON();
...
typedef struct s_CLIPRDR_CAPABILITIES CLIPRDR_CAPABILITIES;

struct s_CLIPRDR_MONITOR_READY
{
	DEFINE_CLIPRDR_HEADER_COMMON();
};
typedef struct s_CLIPRDR_MONITOR_READY CLIPRDR_MONITOR_READY;

struct s_CLIPRDR_TEMP_DIRECTORY
{
	DEFINE_CLIPRDR_HEADER_COMMON();

	char szTempDir[520];
};
typedef struct s_CLIPRDR_TEMP_DIRECTORY CLIPRDR_TEMP_DIRECTORY;

struct s_CLIPRDR_FORMAT
{
	UINT32 formatId;
	char* formatName;
};
typedef struct s_CLIPRDR_FORMAT CLIPRDR_FORMAT;

struct s_CLIPRDR_FORMAT_LIST
{
	DEFINE_CLIPRDR_HEADER_COMMON();
...
typedef struct s_CLIPRDR_FORMAT_LIST CLIPRDR_FORMAT_LIST;

struct s_CLIPRDR_FORMAT_LIST_RESPONSE
{
	DEFINE_CLIPRDR_HEADER_COMMON();
};
typedef struct s_CLIPRDR_FORMAT_LIST_RESPONSE CLIPRDR_FORMAT_LIST_RESPONSE;

struct s_CLIPRDR_LOCK_CLIPBOARD_DATA
{
	DEFINE_CLIPRDR_HEADER_COMMON();

	UINT32 clipDataId;
};
typedef struct s_CLIPRDR_LOCK_CLIPBOARD_DATA CLIPRDR_LOCK_CLIPBOARD_DATA;

struct s_CLIPRDR_UNLOCK_CLIPBOARD_DATA
{
	DEFINE_CLIPRDR_HEADER_COMMON();

	UINT32 clipDataId;
};
typedef struct s_CLIPRDR_UNLOCK_CLIPBOARD_DATA CLIPRDR_UNLOCK_CLIPBOARD_DATA;

struct s_CLIPRDR_FORMAT_DATA_REQUEST
{
	DEFINE_CLIPRDR_HEADER_COMMON();

	UINT32 requestedFormatId;
};
typedef struct s_CLIPRDR_FORMAT_DATA_REQUEST CLIPRDR_FORMAT_DATA_REQUEST;

struct s_CLIPRDR_FORMAT_DATA_RESPONSE
{
	DEFINE_CLIPRDR_HEADER_COMMON();

	const BYTE* requestedFormatData;
};
typedef struct s_CLIPRDR_FORMAT_DATA_RESPONSE CLIPRDR_FORMAT_DATA_RESPONSE;

struct s_CLIPRDR_FILE_CONTENTS_REQUEST
{
	DEFINE_CLIPRDR_HEADER_COMMON();
...
typedef struct s_CLIPRDR_FILE_CONTENTS_REQUEST CLIPRDR_FILE_CONTENTS_REQUEST;

struct s_CLIPRDR_FILE_CONTENTS_RESPONSE
{
	DEFINE_CLIPRDR_HEADER_COMMON();
...
typedef struct s_CLIPRDR_FILE_CONTENTS_RESPONSE CLIPRDR_FILE_CONTENTS_RESPONSE;
