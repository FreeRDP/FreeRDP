...
struct s_DISPLAY_CONTROL_HEADER
{
	UINT32 type;
	UINT32 length;
};
typedef struct s_DISPLAY_CONTROL_HEADER DISPLAY_CONTROL_HEADER;

struct s_DISPLAY_CONTROL_MONITOR_LAYOUT
{
	UINT32 Flags;
	INT32 Left;
	INT32 Top;
...
typedef struct s_DISPLAY_CONTROL_MONITOR_LAYOUT DISPLAY_CONTROL_MONITOR_LAYOUT;

struct s_DISPLAY_CONTROL_MONITOR_LAYOUT_PDU
{
...
typedef struct s_DISPLAY_CONTROL_MONITOR_LAYOUT_PDU DISPLAY_CONTROL_MONITOR_LAYOUT_PDU;
