...
#define data_read_BYTE(_p, _v) \
	do                         \
	{                          \
		_v = *((BYTE*)(_p));   \
	} while (0)
#define data_read_UINT16(_p, _v)                                                 \
	do                                                                           \
	{                                                                            \
		_v = ((UINT16)(*((BYTE*)(_p)))) + ((UINT16)(*(((BYTE*)(_p)) + 1)) << 8); \
	} while (0)
#define data_read_UINT32(_p, _v)                                                              \
	do                                                                                        \
	{                                                                                         \
		_v = (UINT32)(*((BYTE*)(_p))) + ((UINT32)(*(((BYTE*)(_p)) + 1)) << 8) +               \
		     ((UINT32)(*(((BYTE*)(_p)) + 2)) << 16) + ((UINT32)(*(((BYTE*)(_p)) + 3)) << 24); \
	} while (0)
#define data_read_UINT64(_p, _v)                                                               \
	do                                                                                         \
	{                                                                                          \
		_v = (UINT64)(*((BYTE*)(_p))) + ((UINT64)(*(((BYTE*)(_p)) + 1)) << 8) +                \
		     ((UINT64)(*(((BYTE*)(_p)) + 2)) << 16) + ((UINT64)(*(((BYTE*)(_p)) + 3)) << 24) + \
		     ((UINT64)(*(((BYTE*)(_p)) + 4)) << 32) + ((UINT64)(*(((BYTE*)(_p)) + 5)) << 40) + \
		     ((UINT64)(*(((BYTE*)(_p)) + 6)) << 48) + ((UINT64)(*(((BYTE*)(_p)) + 7)) << 56);  \
	} while (0)

#define data_write_BYTE(_p, _v)    \
	do                             \
	{                              \
		*((BYTE*)_p) = (BYTE)(_v); \
	} while (0)
#define data_write_UINT16(_p, _v)                                  \
	do                                                             \
	{                                                              \
		*((BYTE*)_p) = (BYTE)(((UINT16)(_v)) & 0xff);              \
		*(((BYTE*)_p) + 1) = (BYTE)((((UINT16)(_v)) >> 8) & 0xff); \
	} while (0)
#define data_write_UINT32(_p, _v)                                   \
	do                                                              \
	{                                                               \
...
#define data_write_UINT64(_p, _v)                                   \
	do                                                              \
	{                                                               \
...
extern "C"
{
	...
	FREERDP_API MSUSB_INTERFACE_DESCRIPTOR* msusb_msinterface_read(BYTE* data, UINT32 data_size,
	                                                               int* offset);
	FREERDP_API int msusb_msinterface_write(MSUSB_INTERFACE_DESCRIPTOR* MsInterface, BYTE* data,
	                                        int* offset);
	...
	FREERDP_API MSUSB_CONFIG_DESCRIPTOR* msusb_msconfig_read(BYTE* data, UINT32 data_size,
	                                                         UINT32 NumInterfaces);
