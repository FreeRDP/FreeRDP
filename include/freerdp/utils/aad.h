...
extern "C"
{
	...
	/** @return The cloud's short name. @since version 3.33.0 */
	WINPR_ATTR_NODISCARD
	...
	/** @return The cloud's AAD authority. @since version 3.33.0 */
	WINPR_ATTR_NODISCARD
	FREERDP_API const char* freerdp_utils_aad_cloud_get_authority(const FreeRDP_AadCloud* cloud);

	/** @return The cloud's percent-encoded AVD scope. @since version 3.33.0 */
	WINPR_ATTR_NODISCARD
