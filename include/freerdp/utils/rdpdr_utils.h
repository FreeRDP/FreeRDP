...
extern "C"
{
	...
	FREERDP_API WINPR_ATTR_NODISCARD LONG scard_log_status_error(const char* tag, const char* what,
	                                                             LONG status);
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD LONG scard_log_status_error_wlog(wLog* log, const char* what,
	                                                                  LONG status);
