...
struct s_SHADOW_MSG_OUT_POINTER_POSITION_UPDATE
{
	SHADOW_MSG_OUT common;
	UINT32 xPos;
	UINT32 yPos;
};
typedef struct s_SHADOW_MSG_OUT_POINTER_POSITION_UPDATE SHADOW_MSG_OUT_POINTER_POSITION_UPDATE;

struct s_SHADOW_MSG_OUT_POINTER_ALPHA_UPDATE
{
	SHADOW_MSG_OUT common;
	UINT32 xHot;
	UINT32 yHot;
...
typedef struct s_SHADOW_MSG_OUT_POINTER_ALPHA_UPDATE SHADOW_MSG_OUT_POINTER_ALPHA_UPDATE;

struct s_SHADOW_MSG_OUT_AUDIO_OUT_SAMPLES
{
	SHADOW_MSG_OUT common;
...
typedef struct s_SHADOW_MSG_OUT_AUDIO_OUT_SAMPLES SHADOW_MSG_OUT_AUDIO_OUT_SAMPLES;

struct s_SHADOW_MSG_OUT_AUDIO_OUT_VOLUME
{
	SHADOW_MSG_OUT common;
	UINT16 left;
	UINT16 right;
};
typedef struct s_SHADOW_MSG_OUT_AUDIO_OUT_VOLUME SHADOW_MSG_OUT_AUDIO_OUT_VOLUME;
