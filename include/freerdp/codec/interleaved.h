...
extern "C"
{
	...
	FREERDP_API WINPR_ATTR_NODISCARD BOOL interleaved_decompress(
	    BITMAP_INTERLEAVED_CONTEXT* WINPR_RESTRICT interleaved, const BYTE* WINPR_RESTRICT pSrcData,
	...
	FREERDP_API WINPR_ATTR_NODISCARD BOOL interleaved_compress(
	    BITMAP_INTERLEAVED_CONTEXT* WINPR_RESTRICT interleaved, BYTE* WINPR_RESTRICT pDstData,
	    UINT32* WINPR_RESTRICT pDstSize, UINT32 nWidth, UINT32 nHeight,
	    const BYTE* WINPR_RESTRICT pSrcData, UINT32 SrcFormat, UINT32 nSrcStep, UINT32 nXSrc,
	    UINT32 nYSrc, const gdiPalette* WINPR_RESTRICT palette, UINT32 bpp);
	...
	FREERDP_API WINPR_ATTR_NODISCARD BITMAP_INTERLEAVED_CONTEXT*
	bitmap_interleaved_context_new(BOOL Compressor);
