...
extern "C"
{
	...
	typedef enum
	{
		...
		VIDEO_FORMAT_YUYV422 = 1,
		VIDEO_FORMAT_RGB24 = 2,
		VIDEO_FORMAT_BGR24 = 3,
		VIDEO_FORMAT_YUV422P = 4,
		VIDEO_FORMAT_YUV444P = 5,
		VIDEO_FORMAT_NV12 = 23,
		VIDEO_FORMAT_NV21 = 24,
		VIDEO_FORMAT_ARGB = 25,
		VIDEO_FORMAT_RGBA = 26,
		VIDEO_FORMAT_ABGR = 27,
		VIDEO_FORMAT_BGRA = 28,
		VIDEO_FORMAT_YUV411P = 7,
		VIDEO_FORMAT_YUVJ420P = 12,
		VIDEO_FORMAT_YUVJ422P = 13,
		VIDEO_FORMAT_YUVJ444P = 14,
		VIDEO_FORMAT_YUVJ440P = 32,
		VIDEO_FORMAT_YUVJ411P = 33,
		VIDEO_FORMAT_YUV440P = 31,
		VIDEO_FORMAT_RGB32 = 100, /* Will map to platform-specific BGRA/ARGB */
	...
	typedef enum
	{
		VIDEO_CONTEXT_OPTION_DECODER_TYPE, /** MJPEG decoder type */
		VIDEO_CONTEXT_OPTION_SCALING_QUALITY, /** Scaling algorithm quality */
	} VIDEO_CONTEXT_OPTION;
