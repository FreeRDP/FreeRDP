...
typedef struct gdi_palette gdiPalette;
	 ...
	 */
FREERDP_API WINPR_ATTR_NODISCARD DWORD FreeRDPAreColorFormatsEqualNoAlpha(DWORD first,
	                                                                      DWORD second);
...
#define GetColorFormatName(...) FreeRDPGetColorFormatName(__VA_ARGS__)
#endif
	FREERDP_API WINPR_ATTR_NODISCARD const char* FreeRDPGetColorFormatName(UINT32 format);
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD uint32_t FreeRDPGetColorFromatFromName(const char* name);
...
#endif
	FREERDP_API WINPR_ATTR_NODISCARD UINT32 FreeRDPGetColor(UINT32 format, BYTE r, BYTE g, BYTE b,
	                                                        BYTE a);
...
#endif
	FREERDP_API WINPR_ATTR_NODISCARD UINT32 FreeRDPReadColor(const BYTE* WINPR_RESTRICT src,
	                                                         UINT32 format);
...
#endif
	FREERDP_API WINPR_ATTR_NODISCARD BOOL FreeRDPWriteColor(BYTE* WINPR_RESTRICT dst, UINT32 format,
	                                                        UINT32 color);
	FREERDP_API WINPR_ATTR_NODISCARD BOOL FreeRDPWriteColorIgnoreAlpha(BYTE* WINPR_RESTRICT dst,
...
#define GetBytesPerPixel(...) FreeRDPGetBytesPerPixel(__VA_ARGS__)
	...
	WINPR_DEPRECATED_VAR("[since 3.21.0] use freerdp_glyph_convert_ex instead",
	                     WINPR_ATTR_MALLOC(winpr_aligned_free, 1)
	                         FREERDP_API WINPR_ATTR_NODISCARD BYTE* freerdp_glyph_convert(
	 ...
	 */
	WINPR_ATTR_MALLOC(winpr_aligned_free, 1)
	FREERDP_API WINPR_ATTR_NODISCARD BYTE* freerdp_glyph_convert_ex(UINT32 width, UINT32 height,
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_from_monochrome(
	 ...
	 * @return              TRUE if success, FALSE otherwise
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_from_icon_data(
	    BYTE* WINPR_RESTRICT pDstData, UINT32 DstFormat, UINT32 nDstStep, UINT32 nXDst,
	 ...
	 * @return              TRUE if success, FALSE otherwise
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_from_pointer_data(
	    BYTE* WINPR_RESTRICT pDstData, UINT32 DstFormat, UINT32 nDstStep, UINT32 nXDst,
	 ...
	 * @return          TRUE if success, FALSE otherwise
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy(
	 ...
	 * @since version 3.6.0
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_overlap(
	    BYTE* pDstData, DWORD DstFormat, UINT32 nDstStep, UINT32 nXDst, UINT32 nYDst, UINT32 nWidth,
	    UINT32 nHeight, const BYTE* pSrcData, DWORD SrcFormat, UINT32 nSrcStep, UINT32 nXSrc,
	    UINT32 nYSrc, const gdiPalette* WINPR_RESTRICT palette, UINT32 flags);
	 ...
	 * @since version 3.6.0
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_copy_no_overlap(
	 ...
	 * @return          TRUE if success, FALSE otherwise
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_scale(
	    BYTE* WINPR_RESTRICT pDstData, DWORD DstFormat, UINT32 nDstStep, UINT32 nXDst, UINT32 nYDst,
	    UINT32 nDstWidth, UINT32 nDstHeight, const BYTE* WINPR_RESTRICT pSrcData, DWORD SrcFormat,
	    UINT32 nSrcStep, UINT32 nXSrc, UINT32 nYSrc, UINT32 nSrcWidth, UINT32 nSrcHeight);
	 ...
	 * @return          TRUE if success, FALSE otherwise
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_fill(BYTE* WINPR_RESTRICT pDstData,
...
#define FREERDP_IMAGE_FILL_IGNORE_ALPHA 1 /** @since version 3.13.0 */
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL freerdp_image_fill_ex(BYTE* WINPR_RESTRICT pDstData,
	                                                            DWORD DstFormat, UINT32 nDstStep,
	                                                            UINT32 nXDst, UINT32 nYDst,
	                                                            UINT32 nWidth, UINT32 nHeight,
	                                                            UINT32 color, UINT32 flags);
