...
extern "C"
{
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL rectangles_equal(const RECTANGLE_16* r1,
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL rectangles_intersects(const RECTANGLE_16* r1,
	                                                            const RECTANGLE_16* r2);
	 ...
	 * @return if the two rectangles intersect
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL rectangles_intersection(const RECTANGLE_16* r1,
	                                                              const RECTANGLE_16* r2,
	                                                              RECTANGLE_16* dst);
	...
	FREERDP_API WINPR_ATTR_NODISCARD int region16_n_rects(const REGION16* region);
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD const RECTANGLE_16* region16_rects(const REGION16* region,
	                                                                    UINT32* nbRects);

	/** @return the extents rectangle of this region */
	FREERDP_API WINPR_ATTR_NODISCARD const RECTANGLE_16* region16_extents(const REGION16* region);

	/** returns if the rectangle is empty
	 * @param rect the rectangle to check
	 * @return if the rectangle is empty
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL rectangle_is_empty(const RECTANGLE_16* rect);

	/** returns if the region is empty
	 * @param region the region to check
	 * @return if the region is empty
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL region16_is_empty(const REGION16* region);
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL region16_copy(REGION16* dst, const REGION16* src);
	 ...
	 * @return if the operation was successful (false meaning out-of-memory)
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL region16_union_rect(REGION16* dst, const REGION16* src,
	 ...
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL region16_intersects_rect(const REGION16* src,
	 ...
	 * @return if the operation was successful (false meaning out-of-memory)
	 */
	FREERDP_API WINPR_ATTR_NODISCARD BOOL region16_intersect_rect(REGION16* dst,
	                                                              const REGION16* src,
	                                                              const RECTANGLE_16* arg2);
