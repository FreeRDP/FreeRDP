...
FREERDP_API WINPR_ATTR_NODISCARD primitives_t* primitives_get(void);
FREERDP_API void primitives_set_hints(primitive_hints hints);
FREERDP_API WINPR_ATTR_NODISCARD primitive_hints primitives_get_hints(void);
FREERDP_API WINPR_ATTR_NODISCARD primitives_t* primitives_get_generic(void);
FREERDP_API WINPR_ATTR_NODISCARD DWORD primitives_flags(primitives_t* p);
FREERDP_API WINPR_ATTR_NODISCARD BOOL primitives_init(primitives_t* p, primitive_hints hints);
 ...
 */
FREERDP_API WINPR_ATTR_NODISCARD primitives_t* primitives_get_by_type(primitive_hints type);
...
primitives_avc444_frame_type_str(avc444_frame_type type);
 ...
 *  @since version 3.11.0
 */
FREERDP_API WINPR_ATTR_NODISCARD const char* primtives_hint_str(primitive_hints hint);
