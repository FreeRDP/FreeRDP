...
BOOL SetCommState(HANDLE hFile, LPDCB lpDCB)
{
	...
	if (lpDCB->fBinary)
	{
		upcomingTermios.c_lflag &= WINPR_SAFE_INT_CAST(tcflag_t, ~ICANON);
	}
	else
	{
	...
	{
		upcomingTermios.c_iflag &= WINPR_SAFE_INT_CAST(tcflag_t, ~INPCK);
	}
                       ...
                       DWORD dwFlagsAndAttributes, HANDLE hTemplateFile)
{
	...
	upcomingTermios.c_iflag &= WINPR_SAFE_INT_CAST(
