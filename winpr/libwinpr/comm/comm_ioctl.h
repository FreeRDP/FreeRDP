...
#define SPACE_PARITY 4
	...
	typedef struct s_SERIAL_BAUD_RATE
	{
		ULONG BaudRate;
	} SERIAL_BAUD_RATE, *PSERIAL_BAUD_RATE;

	typedef struct s_SERIAL_CHARS
	{
		UCHAR EofChar;
		UCHAR ErrorChar;
		UCHAR BreakChar;
	...
	typedef struct s_SERIAL_LINE_CONTROL
	{
		UCHAR StopBits;
		UCHAR Parity;
		UCHAR WordLength;
	...
	typedef struct s_SERIAL_HANDFLOW
	{
...
#define SERIAL_SP_X25 ((ULONG)0x00000103)
	...
	typedef struct s_SERIAL_TIMEOUTS
	{
...
#define SERIAL_MSR_DCD 0x80
	...
	typedef struct s_SERIAL_QUEUE_SIZE
	{
		ULONG InSize;
		ULONG OutSize;
...
#define SERIAL_PURGE_RXCLEAR 0x00000008
	...
	typedef struct s_SERIAL_STATUS
	{
		ULONG Errors;
		ULONG HoldReasons;
...
#define SERIAL_DCD_STATE ((ULONG)0x00000080)
	 ...
	 */
	typedef struct s_SERIAL_DRIVER
	{
		SERIAL_DRIVER_ID id;
		TCHAR* name;
