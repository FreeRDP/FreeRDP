...
static BOOL CreateProcessExA(HANDLE hToken, LPCSTR lpApplicationName, LPSTR lpCommandLine,
...
{
	return CreateProcessExA(NULL, lpApplicationName, lpCommandLine, lpEnvironment,
...
BOOL CreateProcessAsUserA(HANDLE hToken, LPCSTR lpApplicationName, LPSTR lpCommandLine,
                          ...
                          LPSTARTUPINFOA lpStartupInfo, LPPROCESS_INFORMATION lpProcessInformation)
{
	return CreateProcessExA(hToken, lpApplicationName, lpCommandLine, lpEnvironment,
	                        lpCurrentDirectory, lpStartupInfo, lpProcessInformation);
}
