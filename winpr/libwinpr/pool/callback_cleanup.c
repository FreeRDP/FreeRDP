...
static BOOL CALLBACK init_module(PINIT_ONCE once, PVOID param, PVOID* context)
{
	...
	if (kernel32)
	{
		...
		pReleaseSemaphoreWhenCallbackReturns = (void*)GetProcAddress(kernel32,
		                                       "ReleaseSemaphoreWhenCallbackReturns");
		pReleaseMutexWhenCallbackReturns = (void*)GetProcAddress(kernel32,
		                                   "ReleaseMutexWhenCallbackReturns");
		pLeaveCriticalSectionWhenCallbackReturns = (void*)GetProcAddress(kernel32,
		        "LeaveCriticalSectionWhenCallbackReturns");
		pFreeLibraryWhenCallbackReturns = (void*)GetProcAddress(kernel32, "FreeLibraryWhenCallbackReturns");
		pDisassociateCurrentThreadFromCallback = (void*)GetProcAddress(kernel32,
