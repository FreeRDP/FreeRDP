...
static const TIME_ZONE_RULE_ENTRY TimeZoneRuleTable_28[] = { {
	                                                         ...
	                                                         {
	                                                             640920348000000000ULL,
	                                                             640605852000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             641236572000000000ULL,
	                                                             640921212000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 2, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             641551932000000000ULL,
	                                                             641237436000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             641867292000000000ULL,
	                                                             641552796000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 5, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             642182652000000000ULL,
	                                                             641868156000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             642498876000000000ULL,
	                                                             642183516000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             642814236000000000ULL,
	                                                             642499740000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 10, 6, 5, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             643129596000000000ULL,
	                                                             642815100000000000ULL,
	                                                             60,
	                                                             { 0, 2, 6, 3, 23, 59, 59, 999 },
	                                                             { 0, 11, 6, 1, 23, 59, 59, 999 },
	                                                         },
	                                                         {
	                                                             643444956000000000ULL,
...
const TIME_ZONE_ENTRY TimeZoneTable[] = {
	...
	{ "Easter Island Standard Time", 360, TRUE, "(UTC-06:00) Easter Island",
	  "Easter Island Standard Time", "Easter Island Daylight Time", TimeZoneRuleTable_15, 10 },
	...
	{ "Pacific SA Standard Time", 240, TRUE, "(UTC-04:00) Santiago", "Pacific SA Standard Time",
	  "Pacific SA Daylight Time", TimeZoneRuleTable_30, 10 },
	...
	{ "Morocco Standard Time", 0, TRUE, "(UTC+00:00) Casablanca", "Morocco Standard Time",
	  "Morocco Daylight Time", TimeZoneRuleTable_46, 12 },
	...
	{ "W. Europe Standard Time", -60, TRUE,
	  ...
	  "W. Europe Daylight Time", TimeZoneRuleTable_49, 1 },
	{ "Central Europe Standard Time", -60, TRUE,
	  "(UTC+01:00) Belgrade, Bratislava, Budapest, Ljubljana, Prague",
	  "Central Europe Standard Time", "Central Europe Daylight Time", TimeZoneRuleTable_50, 1 },
	{ "Romance Standard Time", -60, TRUE, "(UTC+01:00) Brussels, Copenhagen, Madrid, Paris",
	  "Romance Standard Time", "Romance Daylight Time", TimeZoneRuleTable_51, 1 },
	{ "Sao Tome Standard Time", -60, TRUE, "(UTC+01:00) Sao Tome", "Sao Tome Standard Time",
	  "Sao Tome Daylight Time", TimeZoneRuleTable_52, 2 },
	...
	{ "West Bank Standard Time", -120, TRUE, "(UTC+02:00) Gaza, Hebron",
	  "West Bank Gaza Standard Time", "West Bank Gaza Daylight Time", TimeZoneRuleTable_61, 7 },
	...
	{ "Caucasus Standard Time", -240, TRUE, "(UTC+04:00) Yerevan", "Caucasus Standard Time",
	  "Caucasus Daylight Time", TimeZoneRuleTable_83, 1 },
	...
	{ "Ekaterinburg Standard Time", -300, TRUE, "(UTC+05:00) Ekaterinburg",
	  "Russia TZ 4 Standard Time", "Russia TZ 4 Daylight Time", TimeZoneRuleTable_86, 5 },
	{ "Pakistan Standard Time", -300, TRUE, "(UTC+05:00) Islamabad, Karachi",
	  "Pakistan Standard Time", "Pakistan Daylight Time", TimeZoneRuleTable_87, 2 },
	...
	{ "Bangladesh Standard Time", -360, TRUE, "(UTC+06:00) Dhaka", "Bangladesh Standard Time",
	  "Bangladesh Daylight Time", TimeZoneRuleTable_92, 1 },
	{ "Omsk Standard Time", -360, TRUE, "(UTC+06:00) Omsk", "Omsk Standard Time",
	  "Omsk Daylight Time", TimeZoneRuleTable_93, 5 },
	...
	{ "Altai Standard Time", -420, TRUE, "(UTC+07:00) Barnaul, Gorno-Altaysk",
	  "Altai Standard Time", "Altai Daylight Time", TimeZoneRuleTable_96, 5 },
	{ "W. Mongolia Standard Time", -420, TRUE, "(UTC+07:00) Hovd", "W. Mongolia Standard Time",
	  "W. Mongolia Daylight Time", TimeZoneRuleTable_97, 3 },
	{ "North Asia Standard Time", -420, TRUE, "(UTC+07:00) Krasnoyarsk",
	  "Russia TZ 6 Standard Time", "Russia TZ 6 Daylight Time", TimeZoneRuleTable_98, 5 },
	{ "N. Central Asia Standard Time", -420, TRUE, "(UTC+07:00) Novosibirsk",
	  "Novosibirsk Standard Time", "Novosibirsk Daylight Time", TimeZoneRuleTable_99, 5 },
	{ "Tomsk Standard Time", -420, TRUE, "(UTC+07:00) Tomsk", "Tomsk Standard Time",
	  "Tomsk Daylight Time", TimeZoneRuleTable_100, 5 },
	...
	{ "North Asia East Standard Time", -480, TRUE, "(UTC+08:00) Irkutsk",
	  "Russia TZ 7 Standard Time", "Russia TZ 7 Daylight Time", TimeZoneRuleTable_102, 5 },
	...
	{ "W. Australia Standard Time", -480, TRUE, "(UTC+08:00) Perth", "W. Australia Standard Time",
	  "W. Australia Daylight Time", TimeZoneRuleTable_104, 4 },
	...
	{ "Ulaanbaatar Standard Time", -480, TRUE, "(UTC+08:00) Ulaanbaatar",
	  "Ulaanbaatar Standard Time", "Ulaanbaatar Daylight Time", TimeZoneRuleTable_106, 2 },
	...
	{ "Transbaikal Standard Time", -540, TRUE, "(UTC+09:00) Chita", "Transbaikal Standard Time",
	  "Transbaikal Daylight Time", TimeZoneRuleTable_108, 7 },
	...
	{ "North Korea Standard Time", -540, TRUE, "(UTC+09:00) Pyongyang", "North Korea Standard Time",
	  "North Korea Daylight Time", TimeZoneRuleTable_110, 4 },
	...
	{ "Yakutsk Standard Time", -540, TRUE, "(UTC+09:00) Yakutsk", "Russia TZ 8 Standard Time",
	  "Russia TZ 8 Daylight Time", TimeZoneRuleTable_112, 5 },
	{ "Cen. Australia Standard Time", -570, TRUE, "(UTC+09:30) Adelaide",
	  "Cen. Australia Standard Time", "Cen. Australia Daylight Time", TimeZoneRuleTable_113, 2 },
	...
	{ "AUS Eastern Standard Time", -600, TRUE, "(UTC+10:00) Canberra, Melbourne, Sydney",
	  "AUS Eastern Standard Time", "AUS Eastern Daylight Time", TimeZoneRuleTable_116, 2 },
	...
	{ "Russia Time Zone 11", -720, TRUE, "(UTC+12:00) Anadyr, Petropavlovsk-Kamchatsky",
	  "Russia TZ 11 Standard Time", "Russia TZ 11 Daylight Time", TimeZoneRuleTable_127, 3 },
	{ "New Zealand Standard Time", -720, TRUE, "(UTC+12:00) Auckland, Wellington",
	  "New Zealand Standard Time", "New Zealand Daylight Time", TimeZoneRuleTable_128, 3 },
	...
	{ "Fiji Standard Time", -720, TRUE, "(UTC+12:00) Fiji", "Fiji Standard Time",
	  "Fiji Daylight Time", TimeZoneRuleTable_130, 11 },
	{ "Kamchatka Standard Time", -720, TRUE, "(UTC+12:00) Petropavlovsk-Kamchatsky - Old",
	  "Kamchatka Standard Time", "Kamchatka Daylight Time", TimeZoneRuleTable_131, 1 },
	{ "Chatham Islands Standard Time", -765, TRUE, "(UTC+12:45) Chatham Islands",
	  "Chatham Islands Standard Time", "Chatham Islands Daylight Time", TimeZoneRuleTable_132, 3 },
	...
	{ "Tonga Standard Time", -780, TRUE, "(UTC+13:00) Nuku'alofa", "Tonga Standard Time",
	  "Tonga Daylight Time", TimeZoneRuleTable_134, 2 },
	{ "Samoa Standard Time", -780, TRUE, "(UTC+13:00) Samoa", "Samoa Standard Time",
	  "Samoa Daylight Time", TimeZoneRuleTable_135, 4 },
