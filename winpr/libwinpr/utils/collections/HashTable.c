...
static inline WINPR_ATTR_NODISCARD BOOL HashTable_IsProbablePrime(size_t oddNumber)
{
...
static inline WINPR_ATTR_NODISCARD size_t HashTable_CalculateIdealNumOfBuckets(wHashTable* table)
{
	WINPR_ASSERT(table);
...
static inline WINPR_ATTR_NODISCARD BOOL HashTable_Equals(wHashTable* table,
...
static inline WINPR_ATTR_NODISCARD wKeyValuePair* HashTable_Get(wHashTable* table, const void* key)
{
	UINT32 hashValue = 0;
