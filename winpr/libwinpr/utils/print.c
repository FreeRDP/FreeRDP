...
void winpr_HexDump(BYTE* data, unsigned int length)
{
	BYTE* p = data;
	unsigned int i, line, offset = 0;
...
void winpr_CArrayDump(BYTE* data, unsigned int length, int width)
{
	BYTE* p = data;
	unsigned int i, line, offset = 0;
