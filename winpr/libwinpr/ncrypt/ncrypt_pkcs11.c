...
} DECLSPEC_ALIGN(64) NCryptP11ProviderHandle;
...
} DECLSPEC_ALIGN(128) NCryptP11KeyHandle;
...
typedef struct
{
	...
	CK_ULONG idLen;
	CK_BYTE id[64];
} DECLSPEC_ALIGN(128) NCryptKeyEnum;
...
typedef struct
{
	...
	CK_ULONG keyIndex;
} DECLSPEC_ALIGN(128) P11EnumKeysState;

typedef struct
{
	const char* label;
	BYTE tag[3];
} DECLSPEC_ALIGN(16) piv_cert_tags_t;
