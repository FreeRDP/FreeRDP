...
static BOOL test_mstsc_store(void)
{
	int status;
	BOOL rc = FALSE;
	PSecBuffer pSecBuffer;
	TEST_NTLM_SERVER* ntlm = NULL;
	BOOL DynamicTest = TRUE;

	/**
	 * Server Initialization
	 */
	ntlm = test_ntlm_server_new();
	...
	status = test_ntlm_server_init(ntlm);
	...
	const char negotiage_message[] = { 0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x01, 0x00,
		                               0x00, 0x00, 0x35, 0xa2, 0x08, 0xe2, 0x00, 0x00, 0x00, 0x00,
		                               0x00, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x1c, 0x00, 0x28, 0x00,
		                               0x00, 0x00, 0x06, 0x00, 0x71, 0x17, 0x00, 0x00, 0x00, 0x0f };
	const char challenge_message[] = {
		
	};
	const char authenticate_message[] = {
		
	};

	/* client -> server NEGOTIATE_MESSAGE */
	ntlm->inputBufferDesc.ulVersion = SECBUFFER_VERSION;
	ntlm->inputBufferDesc.cBuffers = 1;
	ntlm->inputBufferDesc.pBuffers = negotiage_message;
	ntlm->inputBuffer[0].BufferType = SECBUFFER_TOKEN;
	ntlm->outputBufferDesc.ulVersion = SECBUFFER_VERSION;
	ntlm->outputBufferDesc.cBuffers = 1;
	ntlm->outputBufferDesc.pBuffers = &ntlm->outputBuffer[0];
