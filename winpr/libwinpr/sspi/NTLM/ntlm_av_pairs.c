...
static inline WINPR_ATTR_NODISCARD BOOL ntlm_av_pair_get_id(const NTLM_AV_PAIR* pAvPair,
...
static inline WINPR_ATTR_NODISCARD BOOL ntlm_av_pair_get_len(const NTLM_AV_PAIR* pAvPair,
