...
BOOL Test_GetComputerName(void)
{
	...
	{
		fprintf(stderr,
		        "%s: (5) GetComputerNameA returned wrong size %"PRIu32" (expected something in the range from 2 to %"PRIu32")\n",
...
BOOL Test_GetComputerNameEx_Format(COMPUTER_NAME_FORMAT format)
{
	...
	{
		fprintf(stderr,
		        "%s: (5/%d) GetComputerNameExA returned wrong size %"PRIu32" (expected something in the range from %"PRIu32" to %"PRIu32")\n",
