...
typedef struct s_COMMAND_LINE_ARGUMENT_A COMMAND_LINE_ARGUMENT_A;
typedef struct s_COMMAND_LINE_ARGUMENT_W COMMAND_LINE_ARGUMENT_W;

struct s_COMMAND_LINE_ARGUMENT_A
{
	LPCSTR Name;
	DWORD Flags;
	LPCSTR Format;
...
struct s_COMMAND_LINE_ARGUMENT_W
{
	LPCWSTR Name;
	DWORD Flags;
	LPCSTR Format;
