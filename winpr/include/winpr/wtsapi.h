...
{
	UINT32 dwVersion;
	fpRpcStartRemoteControlSession rpcStartRemoteControlSession;
	fpRpcStopRemoteControlSession rpcStopRemoteControlSession;
	fpRpcConnectSession rpcConnectSession;
	fpRpcEnumerateServers rpcEnumerateServers;
	fpRpcOpenServer rpcOpenServer;
	fpRpcOpenServerEx rpcOpenServerEx;
	fpRpcCloseServer rpcCloseServer;
	fpRpcEnumerateSessions rpcEnumerateSessions;
	fpRpcEnumerateSessionsEx rpcEnumerateSessionsEx;
	fpRpcEnumerateProcesses rpcEnumerateProcesses;
	fpRpcTerminateProcess rpcTerminateProcess;
	fpRpcQuerySessionInformation rpcQuerySessionInformation;
	fpRpcQueryUserConfig rpcQueryUserConfig;
	fpRpcSetUserConfig rpcSetUserConfig;
	fpRpcSendMessage rpcSendMessage;
	fpRpcDisconnectSession rpcDisconnectSession;
	fpRpcLogoffSession rpcLogoffSession;
	fpRpcShutdownSystem rpcShutdownSystem;
	fpRpcRegisterSessionNotification rpcRegisterSessionNotification;
	fpRpcUnRegisterSessionNotification rpcUnRegisterSessionNotification;
	fpRpcRegisterSessionNotificationEx rpcRegisterSessionNotificationEx;
	fpRpcUnRegisterSessionNotificationEx rpcUnRegisterSessionNotificationEx;
	fpRpcEnableChildSessions rpcEnableChildSessions;
	fpRpcIsChildSessionsEnabled rpcIsChildSessionsEnabled;
	fpRpcGetChildSessionId rpcGetChildSessionId;
	fpRpcVirtualChannelOpen rpcVirtualChannelOpen;
	fpRpcVirtualChannelOpenEx rpcVirtualChannelOpenEx;
	fpRpcVirtualChannelClose rpcVirtualChannelClose;
};
typedef struct _WTSFunctionTable WTSFunctionTable;
typedef WTSFunctionTable* PWTSFunctionTable;

typedef PWTSFunctionTable (*pWTSApiEntry)();
