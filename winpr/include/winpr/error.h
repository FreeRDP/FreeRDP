...
#define NTE_BAD_UID WINPR_CXX_SAFE_CAST(LONG, 0x80090001)
#define NTE_BAD_HASH WINPR_CXX_SAFE_CAST(LONG, 0x80090002)
#define NTE_BAD_KEY WINPR_CXX_SAFE_CAST(LONG, 0x80090003)
#define NTE_BAD_LEN WINPR_CXX_SAFE_CAST(LONG, 0x80090004)
#define NTE_BAD_DATA WINPR_CXX_SAFE_CAST(LONG, 0x80090005)
#define NTE_BAD_SIGNATURE WINPR_CXX_SAFE_CAST(LONG, 0x80090006)
#define NTE_BAD_VER WINPR_CXX_SAFE_CAST(LONG, 0x80090007)
#define NTE_BAD_ALGID WINPR_CXX_SAFE_CAST(LONG, 0x80090008)
#define NTE_BAD_FLAGS WINPR_CXX_SAFE_CAST(LONG, 0x80090009)
#define NTE_BAD_TYPE WINPR_CXX_SAFE_CAST(LONG, 0x8009000A)
#define NTE_BAD_KEY_STATE WINPR_CXX_SAFE_CAST(LONG, 0x8009000B)
#define NTE_BAD_HASH_STATE WINPR_CXX_SAFE_CAST(LONG, 0x8009000C)
#define NTE_NO_KEY WINPR_CXX_SAFE_CAST(LONG, 0x8009000D)
#define NTE_NO_MEMORY WINPR_CXX_SAFE_CAST(LONG, 0x8009000E)
#define NTE_EXISTS WINPR_CXX_SAFE_CAST(LONG, 0x8009000F)
#define NTE_PERM WINPR_CXX_SAFE_CAST(LONG, 0x80090010)
#define NTE_NOT_FOUND WINPR_CXX_SAFE_CAST(LONG, 0x80090011)
#define NTE_DOUBLE_ENCRYPT WINPR_CXX_SAFE_CAST(LONG, 0x80090012)
#define NTE_BAD_PROVIDER WINPR_CXX_SAFE_CAST(LONG, 0x80090013)
#define NTE_BAD_PROV_TYPE WINPR_CXX_SAFE_CAST(LONG, 0x80090014)
#define NTE_BAD_PUBLIC_KEY WINPR_CXX_SAFE_CAST(LONG, 0x80090015)
#define NTE_BAD_KEYSET WINPR_CXX_SAFE_CAST(LONG, 0x80090016)
#define NTE_PROV_TYPE_NOT_DEF WINPR_CXX_SAFE_CAST(LONG, 0x80090017)
#define NTE_PROV_TYPE_ENTRY_BAD WINPR_CXX_SAFE_CAST(LONG, 0x80090018)
#define NTE_KEYSET_NOT_DEF WINPR_CXX_SAFE_CAST(LONG, 0x80090019)
#define NTE_KEYSET_ENTRY_BAD WINPR_CXX_SAFE_CAST(LONG, 0x8009001A)
#define NTE_PROV_TYPE_NO_MATCH WINPR_CXX_SAFE_CAST(LONG, 0x8009001B)
#define NTE_SIGNATURE_FILE_BAD WINPR_CXX_SAFE_CAST(LONG, 0x8009001C)
#define NTE_PROVIDER_DLL_FAIL WINPR_CXX_SAFE_CAST(LONG, 0x8009001D)
#define NTE_PROV_DLL_NOT_FOUND WINPR_CXX_SAFE_CAST(LONG, 0x8009001E)
#define NTE_BAD_KEYSET_PARAM WINPR_CXX_SAFE_CAST(LONG, 0x8009001F)
#define NTE_FAIL WINPR_CXX_SAFE_CAST(LONG, 0x80090020)
#define NTE_SYS_ERR WINPR_CXX_SAFE_CAST(LONG, 0x80090021)
#define NTE_SILENT_CONTEXT WINPR_CXX_SAFE_CAST(LONG, 0x80090022)
#define NTE_TOKEN_KEYSET_STORAGE_FULL WINPR_CXX_SAFE_CAST(LONG, 0x80090023)
#define NTE_TEMPORARY_PROFILE WINPR_CXX_SAFE_CAST(LONG, 0x80090024)
#define NTE_FIXEDPARAMETER WINPR_CXX_SAFE_CAST(LONG, 0x80090025)
#define NTE_NO_MORE_ITEMS ERROR_NO_MORE_ITEMS
#define NTE_NOT_SUPPORTED ERROR_NOT_SUPPORTED
#define NTE_INVALID_PARAMETER WINPR_CXX_SAFE_CAST(LONG, 0x80090027)
