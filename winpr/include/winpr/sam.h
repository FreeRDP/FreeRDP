...
extern "C"
{
	...
	WINPR_API WINPR_ATTR_NODISCARD WINPR_SAM_ENTRY* SamLookupUserA(WINPR_SAM* sam, LPCSTR User,
	                                                               UINT32 UserLength, LPCSTR Domain,
	                                                               UINT32 DomainLength);
	WINPR_API WINPR_ATTR_NODISCARD WINPR_SAM_ENTRY* SamLookupUserW(WINPR_SAM* sam, LPCWSTR User,
	                                                               UINT32 UserLength,
	                                                               LPCWSTR Domain,
	                                                               UINT32 DomainLength);
	...
	WINPR_API WINPR_ATTR_NODISCARD WINPR_SAM* SamOpen(const char* filename, BOOL readOnly);
