...
extern "C"
{
	...
	WINPR_API WINPR_ATTR_NODISCARD int string_list_length(const char* const* string_list);
	WINPR_API WINPR_ATTR_NODISCARD char** string_list_copy(const char* const* string_list);
