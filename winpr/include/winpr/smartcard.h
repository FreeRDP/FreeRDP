...
typedef struct s_SCARD_IO_REQUEST
{
	DWORD dwProtocol;
	DWORD cbPciLength;
...
typedef struct s_SCARD_ATRMASK
{
	DWORD cbAtr;
	BYTE rgbAtr[36];
	BYTE rgbMask[36];
...
struct s_SCardApiFunctionTable
{
	DWORD dwVersion;
	DWORD dwFlags;
...
typedef struct s_SCardApiFunctionTable SCardApiFunctionTable;
