...
extern "C"
{
	...
	WINPR_API int ASN1BEREncRemoveZeroBits2(ASN1uint32_t* nbits, ASN1octet_t* val,
	                                        ASN1uint32_t minlen);
	...
	WINPR_API int ASN1BERDecEndOfContents(ASN1decoding_t dec, ASN1decoding_t dd,
	                                      ASN1octet_t* pBufEnd);
	WINPR_API int ASN1BERDecOctetString(ASN1decoding_t dec, ASN1uint32_t tag,
	                                    ASN1octetstring_t* val);
	WINPR_API int ASN1BERDecOctetString2(ASN1decoding_t dec, ASN1uint32_t tag,
	                                     ASN1octetstring_t* val);
	...
	WINPR_API int ASN1BERDecChar16String(ASN1decoding_t dec, ASN1uint32_t tag,
	                                     ASN1char16string_t* val);
	WINPR_API int ASN1BERDecChar32String(ASN1decoding_t dec, ASN1uint32_t tag,
	...
	WINPR_API int ASN1BEREncExplicitTag(ASN1encoding_t enc, ASN1uint32_t tag,
