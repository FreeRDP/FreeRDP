...
extern "C"
{
	...
	static inline WINPR_ATTR_NODISCARD UINT8 winpr_Data_Get_UINT8(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD INT8 winpr_Data_Get_INT8(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD UINT16 winpr_Data_Get_UINT16_NE(const void* d)
	{
		const UINT16* ptr = WINPR_ENDIAN_CAST(const UINT16*, d);
		return *ptr;
	}

	static inline WINPR_ATTR_NODISCARD UINT16 winpr_Data_Get_UINT16(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
	...
	static inline WINPR_ATTR_NODISCARD UINT16 winpr_Data_Get_UINT16_BE(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
		const size_t typesize = sizeof(UINT16);
	...
	static inline WINPR_ATTR_NODISCARD INT16 winpr_Data_Get_INT16_NE(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD INT16 winpr_Data_Get_INT16(const void* d)
	{
		const UINT16 u16 = winpr_Data_Get_UINT16(d);
		return WINPR_ENDIAN_CAST(INT16, u16);
	}

	static inline WINPR_ATTR_NODISCARD INT16 winpr_Data_Get_INT16_BE(const void* d)
	{
		const UINT16 u16 = winpr_Data_Get_UINT16_BE(d);
		return WINPR_ENDIAN_CAST(INT16, u16);
	}

	static inline WINPR_ATTR_NODISCARD UINT32 winpr_Data_Get_UINT32_NE(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD UINT32 winpr_Data_Get_UINT32(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
	...
	static inline WINPR_ATTR_NODISCARD UINT32 winpr_Data_Get_UINT32_BE(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
		const size_t typesize = sizeof(UINT32);
	...
	static inline WINPR_ATTR_NODISCARD INT32 winpr_Data_Get_INT32_NE(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD INT32 winpr_Data_Get_INT32(const void* d)
	{
		const UINT32 u32 = winpr_Data_Get_UINT32(d);
		return WINPR_ENDIAN_CAST(INT32, u32);
	}

	static inline WINPR_ATTR_NODISCARD INT32 winpr_Data_Get_INT32_BE(const void* d)
	{
		const UINT32 u32 = winpr_Data_Get_UINT32_BE(d);
		return WINPR_ENDIAN_CAST(INT32, u32);
	}

	static inline WINPR_ATTR_NODISCARD UINT64 winpr_Data_Get_UINT64_NE(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD UINT64 winpr_Data_Get_UINT64(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
	...
	static inline WINPR_ATTR_NODISCARD UINT64 winpr_Data_Get_UINT64_BE(const void* d)
	{
		WINPR_ASSERT(d);
		const UINT8* ptr = WINPR_ENDIAN_CAST(const UINT8*, d);
		const size_t typesize = sizeof(UINT64);
	...
	static inline WINPR_ATTR_NODISCARD INT64 winpr_Data_Get_INT64_NE(const void* d)
	{
		WINPR_ASSERT(d);
	...
	static inline WINPR_ATTR_NODISCARD INT64 winpr_Data_Get_INT64(const void* d)
	{
		const UINT64 u64 = winpr_Data_Get_UINT64(d);
		return WINPR_ENDIAN_CAST(INT64, u64);
	}

	static inline WINPR_ATTR_NODISCARD INT64 winpr_Data_Get_INT64_BE(const void* d)
	{
